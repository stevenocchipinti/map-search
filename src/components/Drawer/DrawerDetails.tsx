        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            ...
            {selectedItem.details && (
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">{selectedItem.details}</p>
            )}
          </div>
          <span className="flex-shrink-0 text-sm text-gray-600 dark:text-gray-400 font-medium bg-gray-100 dark:bg-gray-800 px-3 py-1.5 rounded-lg mt-0.5">
