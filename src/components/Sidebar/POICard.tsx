...
export function POICard({
  ...
  const getCategoryColor = () => {
    switch (category) {
      case "school":
        return "text-blue-400 bg-blue-50 dark:text-blue-300 dark:bg-blue-950"
      case "station":
        return "text-violet-400 bg-violet-50 dark:text-violet-300 dark:bg-violet-950"
      case "supermarket":
        return "text-teal-400 bg-teal-50 dark:text-teal-300 dark:bg-teal-950"
    }
  }
        ...
        <div className="space-y-2">
          ...
          {category === "school" && onOpenSettings && (
            <button
              ...
              className="text-xs text-blue-600 hover:text-blue-700 font-medium dark:text-blue-300 dark:hover:text-blue-200"
            >
          ...
          {hasAlternatives && (
            <Button
              ...
              className="w-full mt-2 text-blue-600 hover:text-blue-700 hover:bg-blue-50 dark:text-blue-300 dark:hover:text-blue-200 dark:hover:bg-blue-950"
            >
              {showAlternatives
                ? "Hide alternatives"
