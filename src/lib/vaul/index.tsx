...
export function Root({
  ...
  const nestedOpenChangeTimer = React.useRef<ReturnType<typeof setTimeout> | null>(null);
  ...
  return (
    // FIX: Pass `modal` prop to DialogPrimitive.Root to allow non-modal behavior
    // This is the key fix for the focus trap issue - the original vaul library
    // didn't pass the modal prop through, causing Radix Dialog to always run
    // in modal mode even when modal={false} was set on Drawer.Root
